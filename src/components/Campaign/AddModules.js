...
const introModule = {title: "Introdution",duration: "10",costPerRecipient: "0"};
const modules = {
  ...
  7: {title: "Attack On IoT Devices",duration: "23 Min",costPerRecipient: "25"},
      ...
      <div className="five wide column">
        ...
        <div className="ui fluid card">
          <div className="content">
            <div className="header">{introModule.title}</div>
            <div className="description">
              Playing Time <b>{introModule.duration} Min</b>
            </div>
            <div className="description">
              Cost Per Recipient <b>{introModule.costPerRecipient}$</b>
            </div>
          </div>
        </div>
      </div>
